...
{ 
  ...
  if (empty($dbresult)) 
  {
    ...
    if (!empty($result->place->bounding_box)) {$geo_bounding_box = 
      $result->place->bounding_box->coordinates[0][0] . "," . $result->place->bounding_box->coordinates[0][1] . "," . $result->place->bounding_box->coordinates[1][0] . "," . $result->place->bounding_box->coordinates[1][1] . "," . $result->place->bounding_box->coordinates[2][0] . "," . $result->place->bounding_box->coordinates[2][1] . "," . $result->place->bounding_box->coordinates[3][0] . "," . $result->place->bounding_box->coordinates[3][1];} else {$geo_bounding_box = "";}
    echo $result->id . ": " . $geo . "\n";
