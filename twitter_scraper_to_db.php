...
{ 
  ...
  if (empty($dbresult)) 
  {
    ...
    if (!empty($result->place)) {$geo_bounding_box = $result->place->bounding_box[0] . "," . $result->place->bounding_box[1] . "," . $result->place->bounding_box[2] . "," . $result->place->bounding_box[3];} else {$geo_bounding_box = "";}
    echo $tweet . $geo;
